...
(function(){
  function patchHome(){
    ...
    // 운세 결과가 나오기 전에는 실제 결과 대신 결과 카드와 같은 형태의 안내 영역을 보여줍니다.
    ...
    if(overview&&!emptySpace){
      ...
      emptySpace.innerHTML='<div class="fortune-placeholder-main"><span>오늘의 운세</span><h3>생년월일을 설정하면 오늘의 운세를 확인할 수 있어요.</h3><p>생년월일을 먼저 설정하고 <b>운세 보기</b> 버튼을 눌러주세요.</p></div><div class="fortune-placeholder-lucky"><h3>오늘의 행운 포인트</h3><div><span>행운의 색</span><b>설정 후 확인</b></div><div><span>행운의 숫자</span><b>—</b></div><div><span>좋은 시간</span><b>—</b></div><div><span>좋은 방향</span><b>—</b></div><div><span>행운의 아이템</span><b>—</b></div><div class="fortune-placeholder-four"><div><b>재물운</b><strong>—</strong><small>생년월일을 설정하면 확인할 수 있어요.</small></div><div><b>애정운</b><strong>—</strong><small>생년월일을 설정하면 확인할 수 있어요.</small></div><div><b>직장운</b><strong>—</strong><small>생년월일을 설정하면 확인할 수 있어요.</small></div><div><b>건강운</b><strong>—</strong><small>생년월일을 설정하면 확인할 수 있어요.</small></div></div></div>';
...
// 날짜 선택 UI와 초기화 버튼, 입력 전 안내 카드를 깔끔하게 표시합니다.
...
#fortune .overview,#fortune .four{display:none}#fortune .overview.fortune-visible{display:grid}#fortune .four.fortune-visible{display:grid}.fortune-empty{display:grid;grid-template-columns:1.35fr .65fr;grid-template-rows:auto auto;gap:10px;width:100%;box-sizing:border-box}.fortune-placeholder-main,.fortune-placeholder-lucky{background:var(--paper);border:1px solid var(--line);border-radius:15px;box-sizing:border-box}.fortune-placeholder-main{min-height:190px;padding:17px 19px}.fortune-placeholder-main>span{display:inline-block;padding:6px 10px;border-radius:99px;background:var(--soft);color:#78907f;font-size:11px;font-weight:900}.fortune-placeholder-main h3{font-size:24px;margin:11px 0 6px;color:#52675a}.fortune-placeholder-main p{font-size:13px;color:#9a9f98;line-height:1.75;margin:0}.fortune-placeholder-main p b{color:#6e8c78}.fortune-placeholder-lucky{padding:15px 17px}.fortune-placeholder-lucky>h3{font-size:16px;margin:0 0 7px;color:#52675a}.fortune-placeholder-lucky>div:not(.fortune-placeholder-four){display:flex;justify-content:space-between;align-items:center;padding:8px 0;border-bottom:1px dashed #e4dfd5;font-size:12px;color:#a0a59f}.fortune-placeholder-lucky>div:not(.fortune-placeholder-four) b{padding:6px 9px;border-radius:8px;background:#f2f4ee;color:#9aa39b;font-size:11px}.fortune-placeholder-four{grid-column:1 / -1;display:grid!important;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:10px}.fortune-placeholder-four>div{background:var(--paper);border:1px solid var(--line);border-radius:15px;padding:14px;min-height:91px;box-sizing:border-box}.fortune-placeholder-four b{display:block;font-size:12px;color:#9a9f98;margin-bottom:8px}.fortune-placeholder-four strong{display:block;font-size:18px;color:#b0b4ae}.fortune-placeholder-four small{display:block;color:#aaaFAA;font-size:10px;margin-top:6px;line-height:1.45}.fortune-empty.fortune-hidden{display:none}
@media(max-width:760px) and (hover:none) and (pointer:coarse){.birth-date-trigger{width:auto;flex:1;height:46px}.birth-date-icon{width:26px;flex-basis:26px}.birth-picker{width:calc(100vw - 24px);max-width:320px}.bp-day,.bp-empty{width:100%;height:34px}.birth-form{display:flex;flex-wrap:wrap}.birth-form .birth-date-trigger{flex:1;min-width:0}.birth-reset{height:38px}.fortune-empty{grid-template-columns:1fr}.fortune-placeholder-main{min-height:170px}.fortune-placeholder-four{grid-template-columns:repeat(2,1fr)}.fortune-placeholder-four>div{min-height:86px}}
