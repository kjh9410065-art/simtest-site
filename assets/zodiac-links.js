...
(function(){
  function patchHome(){
    ...
    function showFortune(){const overview=document.querySelector('#fortune .overview'),four=document.querySelector('#fortune .four');if(overview)overview.classList.add('fortune-visible');if(four)four.classList.add('fortune-visible');}
    const overview=document.querySelector('#fortune .overview'),four=document.querySelector('#fortune .four');
    if(overview)overview.classList.remove('fortune-visible');
    if(four)four.classList.remove('fortune-visible');
  }
...
#fortune .overview,#fortune .four{display:none}#fortune .overview.fortune-visible{display:grid}#fortune .four.fortune-visible{display:grid}
