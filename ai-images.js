...
(() => {
  ...
  // 승인된 시안의 이미지를 새로 생성하도록 버전을 올립니다.
  const imageVersion = "ai-20260909-v9";

  const style = document.createElement("style");
  style.textContent = `
    /* 승인된 시안과 같은 비율과 카드 겹침을 유지합니다. */
    .home-hero{height:auto!important;min-height:0!important;overflow:hidden!important}
    .hero-inner{height:auto!important;min-height:0!important;padding:44px 28px 104px!important;align-items:center!important}
    ...
    .quick{margin-top:-108px!important}
    .quick-card img{display:block!important;width:100%!important;height:138px!important;min-height:138px!important;object-fit:cover!important;background:#171d50!important}
    ...
    @media (min-width:1400px){
      .hero-inner{padding:48px 28px 122px!important}
      .hero-art img{height:410px!important;min-height:410px!important}
      .quick{margin-top:-132px!important}
      .quick-card img{height:145px!important;min-height:145px!important}
    }

    @media (max-width:1180px){
      .hero-inner{grid-template-columns:minmax(250px,.9fr) minmax(320px,1.1fr)!important;gap:28px!important;padding-left:22px!important;padding-right:22px!important;padding-bottom:92px!important}
      .hero-art img{height:320px!important;min-height:320px!important}
      .quick{margin-top:-88px!important}
    }

    @media (max-width:720px){
      .home-hero{min-height:0!important}
      .hero-inner{min-height:0!important;padding:34px 18px 42px!important;display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:22px!important}
    ...
    @media (max-width:900px) and (orientation:landscape) and (max-height:600px){
      .hero-inner{min-height:0!important;padding:24px 30px 72px!important;display:grid!important;grid-template-columns:1fr 1fr!important;gap:24px!important}
      .hero-art{order:0!important}
      .hero-art img{height:260px!important;min-height:260px!important}
      .quick{margin-top:-62px!important}
    ...
    @media (max-width:390px){
      ...
      .quick{margin-top:-8px!important}
  ...
  async function requestAIImage(type) {
    ...
    for (let attempt = 1; attempt <= maxAttempts; attempt += 1) {
      try {
        // API가 실제 이미지 데이터를 반환하는지 먼저 검증합니다.
  ...
  (async () => {
    ...
    // 같은 종류의 이미지는 한 번만 AI로 생성한 뒤 모든 영역에서 공유합니다.
    const cache = new Map();
